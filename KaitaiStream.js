 ...
 */
  ...
  /**
  Writes a 32-bit big-endian float to the stream.
 ...
 */
  ...
  var ConsistencyError = (KaitaiStream.ConsistencyError = function (
    id,
    expected,
    actual
  ) {
  ...
  */
  KaitaiStream.prototype.ensureBytesLeft = function (length, pos = undefined) {
    pos = pos ?? this.pos;
    if (pos + length > this.size) {
      throw new EOFError(length, this.size - pos);
    }
  };
